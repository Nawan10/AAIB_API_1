...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CropVarietyCropType} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CropVarietyCropTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /crop-variety-crop-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CropVarietyCropTypeCriteria implements Serializable, Criteria {
    ...
    public CropVarietyCropTypeCriteria() {}

    public CropVarietyCropTypeCriteria(CropVarietyCropTypeCriteria other) {
    ...
    @Override
    public CropVarietyCropTypeCriteria copy() {
        return new CropVarietyCropTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CropVarietyCropTypeCriteria that = (CropVarietyCropTypeCriteria) o;
        return (
    ...
    public String toString() {
        return "CropVarietyCropTypeCriteria{" +
