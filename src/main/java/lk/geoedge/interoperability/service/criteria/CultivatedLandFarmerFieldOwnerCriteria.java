...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CultivatedLandFarmerFieldOwner} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CultivatedLandFarmerFieldOwnerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cultivated-land-farmer-field-owners?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CultivatedLandFarmerFieldOwnerCriteria implements Serializable, Criteria {
    ...
    public CultivatedLandFarmerFieldOwnerCriteria() {}

    public CultivatedLandFarmerFieldOwnerCriteria(CultivatedLandFarmerFieldOwnerCriteria other) {
    ...
    @Override
    public CultivatedLandFarmerFieldOwnerCriteria copy() {
        return new CultivatedLandFarmerFieldOwnerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CultivatedLandFarmerFieldOwnerCriteria that = (CultivatedLandFarmerFieldOwnerCriteria) o;
        return (
    ...
    public String toString() {
        return "CultivatedLandFarmerFieldOwnerCriteria{" +
