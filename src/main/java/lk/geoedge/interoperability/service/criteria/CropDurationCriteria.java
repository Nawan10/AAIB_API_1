...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CropDuration} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CropDurationResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /crop-durations?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CropDurationCriteria implements Serializable, Criteria {
    ...
    public CropDurationCriteria() {}

    public CropDurationCriteria(CropDurationCriteria other) {
    ...
    @Override
    public CropDurationCriteria copy() {
        return new CropDurationCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CropDurationCriteria that = (CropDurationCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, duration, name, stages, addedBy, addedDate, cropId, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "CropDurationCriteria{" +
