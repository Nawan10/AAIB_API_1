...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CultivatedLand} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CultivatedLandResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cultivated-lands?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CultivatedLandCriteria implements Serializable, Criteria {
    ...
    public CultivatedLandCriteria() {}

    public CultivatedLandCriteria(CultivatedLandCriteria other) {
    ...
    @Override
    public CultivatedLandCriteria copy() {
        return new CultivatedLandCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CultivatedLandCriteria that = (CultivatedLandCriteria) o;
        return (
