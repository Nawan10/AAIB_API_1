...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.IndexPayoutEventListFarmer} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.IndexPayoutEventListFarmerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /index-payout-event-list-farmers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class IndexPayoutEventListFarmerCriteria implements Serializable, Criteria {
    ...
    public IndexPayoutEventListFarmerCriteria() {}

    public IndexPayoutEventListFarmerCriteria(IndexPayoutEventListFarmerCriteria other) {
    ...
    @Override
    public IndexPayoutEventListFarmerCriteria copy() {
        return new IndexPayoutEventListFarmerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final IndexPayoutEventListFarmerCriteria that = (IndexPayoutEventListFarmerCriteria) o;
        return (
    ...
    public String toString() {
        return "IndexPayoutEventListFarmerCriteria{" +
