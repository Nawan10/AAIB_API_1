...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.Farmer} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.FarmerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /farmers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FarmerCriteria implements Serializable, Criteria {
    ...
    public FarmerCriteria() {}

    public FarmerCriteria(FarmerCriteria other) {
    ...
    @Override
    public FarmerCriteria copy() {
        return new FarmerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FarmerCriteria that = (FarmerCriteria) o;
        return (
