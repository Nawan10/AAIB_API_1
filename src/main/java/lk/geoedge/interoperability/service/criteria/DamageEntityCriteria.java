...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.DamageEntity} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.DamageEntityResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /damage-entities?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DamageEntityCriteria implements Serializable, Criteria {
    ...
    public DamageEntityCriteria() {}

    public DamageEntityCriteria(DamageEntityCriteria other) {
    ...
    @Override
    public DamageEntityCriteria copy() {
        return new DamageEntityCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DamageEntityCriteria that = (DamageEntityCriteria) o;
        return (
