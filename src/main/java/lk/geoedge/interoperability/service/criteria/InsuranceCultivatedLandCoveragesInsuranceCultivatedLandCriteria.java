...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.InsuranceCultivatedLandCoveragesInsuranceCultivatedLand} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.InsuranceCultivatedLandCoveragesInsuranceCultivatedLandResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /insurance-cultivated-land-coverages-insurance-cultivated-lands?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InsuranceCultivatedLandCoveragesInsuranceCultivatedLandCriteria implements Serializable, Criteria {
    ...
    public InsuranceCultivatedLandCoveragesInsuranceCultivatedLandCriteria() {}

    public InsuranceCultivatedLandCoveragesInsuranceCultivatedLandCriteria(
        InsuranceCultivatedLandCoveragesInsuranceCultivatedLandCriteria other
    ) {
    ...
    @Override
    public InsuranceCultivatedLandCoveragesInsuranceCultivatedLandCriteria copy() {
        return new InsuranceCultivatedLandCoveragesInsuranceCultivatedLandCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InsuranceCultivatedLandCoveragesInsuranceCultivatedLandCriteria that =
            (InsuranceCultivatedLandCoveragesInsuranceCultivatedLandCriteria) o;
        return (
    ...
    public String toString() {
        return "InsuranceCultivatedLandCoveragesInsuranceCultivatedLandCriteria{" +
