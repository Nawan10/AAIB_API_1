...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.InsuranceCultivatedLandCropType} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.InsuranceCultivatedLandCropTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /insurance-cultivated-land-crop-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InsuranceCultivatedLandCropTypeCriteria implements Serializable, Criteria {
    ...
    public InsuranceCultivatedLandCropTypeCriteria() {}

    public InsuranceCultivatedLandCropTypeCriteria(InsuranceCultivatedLandCropTypeCriteria other) {
    ...
    @Override
    public InsuranceCultivatedLandCropTypeCriteria copy() {
        return new InsuranceCultivatedLandCropTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InsuranceCultivatedLandCropTypeCriteria that = (InsuranceCultivatedLandCropTypeCriteria) o;
        return (
    ...
    public String toString() {
        return "InsuranceCultivatedLandCropTypeCriteria{" +
