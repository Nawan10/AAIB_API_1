...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.Damage} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.DamageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /damages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class DamageCriteria implements Serializable, Criteria {
    ...
    public DamageCriteria(DamageCriteria other) {
    ...
    @Override
    public DamageCriteria copy() {
        return new DamageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final DamageCriteria that = (DamageCriteria) o;
        return (
