...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CultivatedLandFarmerLand} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CultivatedLandFarmerLandResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cultivated-land-farmer-lands?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CultivatedLandFarmerLandCriteria implements Serializable, Criteria {
    ...
    public CultivatedLandFarmerLandCriteria() {}

    public CultivatedLandFarmerLandCriteria(CultivatedLandFarmerLandCriteria other) {
    ...
    @Override
    public CultivatedLandFarmerLandCriteria copy() {
        return new CultivatedLandFarmerLandCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CultivatedLandFarmerLandCriteria that = (CultivatedLandFarmerLandCriteria) o;
        return (
    ...
    public String toString() {
        return "CultivatedLandFarmerLandCriteria{" +
