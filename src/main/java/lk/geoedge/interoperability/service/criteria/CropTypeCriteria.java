...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CropType} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CropTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /crop-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CropTypeCriteria implements Serializable, Criteria {
    ...
    public CropTypeCriteria() {}

    public CropTypeCriteria(CropTypeCriteria other) {
    ...
    @Override
    public CropTypeCriteria copy() {
        return new CropTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CropTypeCriteria that = (CropTypeCriteria) o;
        return (
