...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CultivatedLandFarmer} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CultivatedLandFarmerResource} to receive all the possible filtering options from
...
public class CultivatedLandFarmerCriteria implements Serializable, Criteria {
    ...
    public CultivatedLandFarmerCriteria() {}

    public CultivatedLandFarmerCriteria(CultivatedLandFarmerCriteria other) {
    ...
    @Override
    public CultivatedLandFarmerCriteria copy() {
        return new CultivatedLandFarmerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CultivatedLandFarmerCriteria that = (CultivatedLandFarmerCriteria) o;
        return (
    ...
    public String toString() {
        return "CultivatedLandFarmerCriteria{" +
