...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.FarmerFieldOwnerCropType} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.FarmerFieldOwnerCropTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /farmer-field-owner-crop-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FarmerFieldOwnerCropTypeCriteria implements Serializable, Criteria {
    ...
    public FarmerFieldOwnerCropTypeCriteria() {}

    public FarmerFieldOwnerCropTypeCriteria(FarmerFieldOwnerCropTypeCriteria other) {
    ...
    @Override
    public FarmerFieldOwnerCropTypeCriteria copy() {
        return new FarmerFieldOwnerCropTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FarmerFieldOwnerCropTypeCriteria that = (FarmerFieldOwnerCropTypeCriteria) o;
        return (
    ...
    public String toString() {
        return "FarmerFieldOwnerCropTypeCriteria{" +
