...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.IndexPolicyCropType} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.IndexPolicyCropTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /index-policy-crop-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class IndexPolicyCropTypeCriteria implements Serializable, Criteria {
    ...
    public IndexPolicyCropTypeCriteria() {}

    public IndexPolicyCropTypeCriteria(IndexPolicyCropTypeCriteria other) {
    ...
    @Override
    public IndexPolicyCropTypeCriteria copy() {
        return new IndexPolicyCropTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final IndexPolicyCropTypeCriteria that = (IndexPolicyCropTypeCriteria) o;
        return (
    ...
    public String toString() {
        return "IndexPolicyCropTypeCriteria{" +
