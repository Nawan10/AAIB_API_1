...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.IndexPayoutEventListCultivatedLand} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.IndexPayoutEventListCultivatedLandResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /index-payout-event-list-cultivated-lands?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class IndexPayoutEventListCultivatedLandCriteria implements Serializable, Criteria {
    ...
    public IndexPayoutEventListCultivatedLandCriteria() {}

    public IndexPayoutEventListCultivatedLandCriteria(IndexPayoutEventListCultivatedLandCriteria other) {
    ...
    @Override
    public IndexPayoutEventListCultivatedLandCriteria copy() {
        return new IndexPayoutEventListCultivatedLandCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final IndexPayoutEventListCultivatedLandCriteria that = (IndexPayoutEventListCultivatedLandCriteria) o;
        return (
    ...
    public String toString() {
        return "IndexPayoutEventListCultivatedLandCriteria{" +
