...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CanlendarCropCropType} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CanlendarCropCropTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /canlendar-crop-crop-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CanlendarCropCropTypeCriteria implements Serializable, Criteria {
    ...
    public CanlendarCropCropTypeCriteria() {}

    public CanlendarCropCropTypeCriteria(CanlendarCropCropTypeCriteria other) {
    ...
    @Override
    public CanlendarCropCropTypeCriteria copy() {
        return new CanlendarCropCropTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CanlendarCropCropTypeCriteria that = (CanlendarCropCropTypeCriteria) o;
        return (
    ...
    public String toString() {
        return "CanlendarCropCropTypeCriteria{" +
