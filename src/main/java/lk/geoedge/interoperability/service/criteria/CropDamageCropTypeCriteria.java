...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CropDamageCropType} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CropDamageCropTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /crop-damage-crop-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CropDamageCropTypeCriteria implements Serializable, Criteria {
    ...
    public CropDamageCropTypeCriteria() {}

    public CropDamageCropTypeCriteria(CropDamageCropTypeCriteria other) {
    ...
    @Override
    public CropDamageCropTypeCriteria copy() {
        return new CropDamageCropTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CropDamageCropTypeCriteria that = (CropDamageCropTypeCriteria) o;
        return (
    ...
    public String toString() {
        return "CropDamageCropTypeCriteria{" +
