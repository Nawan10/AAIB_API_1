...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CultivatedLandEntity} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CultivatedLandEntityResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cultivated-land-entities?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CultivatedLandEntityCriteria implements Serializable, Criteria {
    ...
    public CultivatedLandEntityCriteria() {}

    public CultivatedLandEntityCriteria(CultivatedLandEntityCriteria other) {
    ...
    @Override
    public CultivatedLandEntityCriteria copy() {
        return new CultivatedLandEntityCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CultivatedLandEntityCriteria that = (CultivatedLandEntityCriteria) o;
        return (
    ...
    public String toString() {
        return "CultivatedLandEntityCriteria{" +
