...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.InsuranceCropCropType} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.InsuranceCropCropTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /insurance-crop-crop-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InsuranceCropCropTypeCriteria implements Serializable, Criteria {
    ...
    public InsuranceCropCropTypeCriteria() {}

    public InsuranceCropCropTypeCriteria(InsuranceCropCropTypeCriteria other) {
    ...
    @Override
    public InsuranceCropCropTypeCriteria copy() {
        return new InsuranceCropCropTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InsuranceCropCropTypeCriteria that = (InsuranceCropCropTypeCriteria) o;
        return (
    ...
    public String toString() {
        return "InsuranceCropCropTypeCriteria{" +
