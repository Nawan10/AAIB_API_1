...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CropDamageDamage} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CropDamageDamageResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /crop-damage-damages?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CropDamageDamageCriteria implements Serializable, Criteria {
    ...
    public CropDamageDamageCriteria() {}

    public CropDamageDamageCriteria(CropDamageDamageCriteria other) {
    ...
    @Override
    public CropDamageDamageCriteria copy() {
        return new CropDamageDamageCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CropDamageDamageCriteria that = (CropDamageDamageCriteria) o;
        return (
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, damageName, damageCode, damageFamily, damageGenus, damageSpecies, createdAt, addedBy, distinct);
    }

    // prettier-ignore
    @Override
    public String toString() {
        return "CropDamageDamageCriteria{" +
