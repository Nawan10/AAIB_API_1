...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CultivatedCropCultivatedLand} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CultivatedCropCultivatedLandResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cultivated-crop-cultivated-lands?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CultivatedCropCultivatedLandCriteria implements Serializable, Criteria {
    ...
    public CultivatedCropCultivatedLandCriteria() {}

    public CultivatedCropCultivatedLandCriteria(CultivatedCropCultivatedLandCriteria other) {
    ...
    @Override
    public CultivatedCropCultivatedLandCriteria copy() {
        return new CultivatedCropCultivatedLandCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CultivatedCropCultivatedLandCriteria that = (CultivatedCropCultivatedLandCriteria) o;
        return (
    ...
    public String toString() {
        return "CultivatedCropCultivatedLandCriteria{" +
