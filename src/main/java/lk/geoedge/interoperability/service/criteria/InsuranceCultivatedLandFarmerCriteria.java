...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.InsuranceCultivatedLandFarmer} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.InsuranceCultivatedLandFarmerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /insurance-cultivated-land-farmers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InsuranceCultivatedLandFarmerCriteria implements Serializable, Criteria {
    ...
    public InsuranceCultivatedLandFarmerCriteria() {}

    public InsuranceCultivatedLandFarmerCriteria(InsuranceCultivatedLandFarmerCriteria other) {
    ...
    @Override
    public InsuranceCultivatedLandFarmerCriteria copy() {
        return new InsuranceCultivatedLandFarmerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InsuranceCultivatedLandFarmerCriteria that = (InsuranceCultivatedLandFarmerCriteria) o;
        return (
    ...
    public String toString() {
        return "InsuranceCultivatedLandFarmerCriteria{" +
