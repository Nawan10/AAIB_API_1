...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.CultivatedCropCropType} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.CultivatedCropCropTypeResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /cultivated-crop-crop-types?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CultivatedCropCropTypeCriteria implements Serializable, Criteria {
    ...
    public CultivatedCropCropTypeCriteria() {}

    public CultivatedCropCropTypeCriteria(CultivatedCropCropTypeCriteria other) {
    ...
    @Override
    public CultivatedCropCropTypeCriteria copy() {
        return new CultivatedCropCropTypeCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final CultivatedCropCropTypeCriteria that = (CultivatedCropCropTypeCriteria) o;
        return (
    ...
    public String toString() {
        return "CultivatedCropCropTypeCriteria{" +
