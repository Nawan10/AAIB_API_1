...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.InsurancePolicy} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.InsurancePolicyResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /insurance-policies?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InsurancePolicyCriteria implements Serializable, Criteria {
    ...
    public InsurancePolicyCriteria() {}

    public InsurancePolicyCriteria(InsurancePolicyCriteria other) {
    ...
    @Override
    public InsurancePolicyCriteria copy() {
        return new InsurancePolicyCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final InsurancePolicyCriteria that = (InsurancePolicyCriteria) o;
        return (
    ...
    public String toString() {
        return "InsurancePolicyCriteria{" +
