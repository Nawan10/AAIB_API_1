...
/**
 * Criteria class for the {@link lk.geoedge.interoperability.domain.FarmerFieldLandOwnerFarmer} entity. This class is used
 * in {@link lk.geoedge.interoperability.web.rest.FarmerFieldLandOwnerFarmerResource} to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /farmer-field-land-owner-farmers?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
 * As Spring is unable to properly convert the types, unless specific {@link Filter} class are used, we need to use
 * fix type specific filters.
 */
@ParameterObject
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FarmerFieldLandOwnerFarmerCriteria implements Serializable, Criteria {
    ...
    public FarmerFieldLandOwnerFarmerCriteria() {}

    public FarmerFieldLandOwnerFarmerCriteria(FarmerFieldLandOwnerFarmerCriteria other) {
    ...
    @Override
    public FarmerFieldLandOwnerFarmerCriteria copy() {
        return new FarmerFieldLandOwnerFarmerCriteria(this);
    }
    ...
    public boolean equals(Object o) {
        ...
        final FarmerFieldLandOwnerFarmerCriteria that = (FarmerFieldLandOwnerFarmerCriteria) o;
        return (
    ...
    public String toString() {
        return "FarmerFieldLandOwnerFarmerCriteria{" +
