...
public class CropType implements Serializable {
    ...
    public CropType crop(String crop) {
        this.setCrop(crop);
        return this;
    }
    ...
    public CropType image(String image) {
        this.setImage(image);
        return this;
    }
    ...
    public CropType mainCrop(Integer mainCrop) {
    ...
    public CropType cropCode(String cropCode) {
    ...
    public CropType noOfStages(String noOfStages) {
    ...
    public CropType description(String description) {
    ...
    public CropType cropTypesId(Integer cropTypesId) {
    ...
    public CropType unitsId(Integer unitsId) {
    ...
    public CropType area(Double area) {
        this.setArea(area);
        return this;
    }
    ...
    public CropType sumInsured(Double sumInsured) {
    ...
    public CropType minSumInsured(Double minSumInsured) {
    ...
    public CropType maxSumInsured(Double maxSumInsured) {
    ...
    public CropType subsidisedPremiumRate(Double subsidisedPremiumRate) {
