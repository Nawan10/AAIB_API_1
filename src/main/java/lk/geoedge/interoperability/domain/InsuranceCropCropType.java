...
/**
 * A InsuranceCropCropType.
 */
@Entity
@Table(name = "crop_type")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InsuranceCropCropType implements Serializable {
    ...
    public InsuranceCropCropType id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public InsuranceCropCropType crop(String crop) {
        this.setCrop(crop);
        return this;
    }
    ...
    public InsuranceCropCropType image(String image) {
        this.setImage(image);
        return this;
    }
    ...
    public InsuranceCropCropType mainCrop(Integer mainCrop) {
    ...
    public InsuranceCropCropType cropCode(String cropCode) {
    ...
    public InsuranceCropCropType noOfStages(String noOfStages) {
    ...
    public InsuranceCropCropType description(String description) {
    ...
    public InsuranceCropCropType cropTypesId(Integer cropTypesId) {
    ...
    public InsuranceCropCropType unitsId(Integer unitsId) {
    ...
    public InsuranceCropCropType area(Double area) {
        this.setArea(area);
        return this;
    }
    ...
    public InsuranceCropCropType sumInsured(Double sumInsured) {
    ...
    public InsuranceCropCropType minSumInsured(Double minSumInsured) {
    ...
    public InsuranceCropCropType maxSumInsured(Double maxSumInsured) {
    ...
    public InsuranceCropCropType subsidisedPremiumRate(Double subsidisedPremiumRate) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InsuranceCropCropType)) {
            return false;
        }
        return getId() != null && getId().equals(((InsuranceCropCropType) o).getId());
    }
