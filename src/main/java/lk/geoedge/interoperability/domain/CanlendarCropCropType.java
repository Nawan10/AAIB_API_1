...
/**
 * A CanlendarCropCropType.
 */
@Entity
@Table(name = "crop_type")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CanlendarCropCropType implements Serializable {
    ...
    public CanlendarCropCropType id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public CanlendarCropCropType crop(String crop) {
        this.setCrop(crop);
        return this;
    }
    ...
    public CanlendarCropCropType image(String image) {
        this.setImage(image);
        return this;
    }
    ...
    public CanlendarCropCropType mainCrop(Integer mainCrop) {
    ...
    public CanlendarCropCropType cropCode(String cropCode) {
    ...
    public CanlendarCropCropType noOfStages(String noOfStages) {
    ...
    public CanlendarCropCropType description(String description) {
    ...
    public CanlendarCropCropType cropTypesId(Integer cropTypesId) {
    ...
    public CanlendarCropCropType unitsId(Integer unitsId) {
    ...
    public CanlendarCropCropType area(Double area) {
        this.setArea(area);
        return this;
    }
    ...
    public CanlendarCropCropType sumInsured(Double sumInsured) {
    ...
    public CanlendarCropCropType minSumInsured(Double minSumInsured) {
    ...
    public CanlendarCropCropType maxSumInsured(Double maxSumInsured) {
    ...
    public CanlendarCropCropType subsidisedPremiumRate(Double subsidisedPremiumRate) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CanlendarCropCropType)) {
            return false;
        }
        return getId() != null && getId().equals(((CanlendarCropCropType) o).getId());
    }
