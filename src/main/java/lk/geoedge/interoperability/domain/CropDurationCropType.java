...
/**
 * A CropDurationCropType.
 */
@Entity
@Table(name = "crop_type")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class CropDurationCropType implements Serializable {
    ...
    public CropDurationCropType id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public CropDurationCropType crop(String crop) {
        this.setCrop(crop);
        return this;
    }
    ...
    public CropDurationCropType image(String image) {
        this.setImage(image);
        return this;
    }
    ...
    public CropDurationCropType mainCrop(Integer mainCrop) {
    ...
    public CropDurationCropType cropCode(String cropCode) {
    ...
    public CropDurationCropType noOfStages(String noOfStages) {
    ...
    public CropDurationCropType description(String description) {
    ...
    public CropDurationCropType cropTypesId(Integer cropTypesId) {
    ...
    public CropDurationCropType unitsId(Integer unitsId) {
    ...
    public CropDurationCropType area(Double area) {
        this.setArea(area);
        return this;
    }
    ...
    public CropDurationCropType sumInsured(Double sumInsured) {
    ...
    public CropDurationCropType minSumInsured(Double minSumInsured) {
    ...
    public CropDurationCropType maxSumInsured(Double maxSumInsured) {
    ...
    public CropDurationCropType subsidisedPremiumRate(Double subsidisedPremiumRate) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof CropDurationCropType)) {
            return false;
        }
        return getId() != null && getId().equals(((CropDurationCropType) o).getId());
    }
