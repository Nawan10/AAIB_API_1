...
public class InsurancePolicy implements Serializable {
    ...
    public InsurancePolicy id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public InsurancePolicy name(String name) {
        this.setName(name);
        return this;
    }
    ...
    public InsurancePolicy policyNo(String policyNo) {
    ...
    public InsurancePolicy isActivate(Integer isActivate) {
