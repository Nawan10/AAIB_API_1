...
/**
 * A FarmerFieldOwnerCropType.
 */
@Entity
@Table(name = "crop_type")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class FarmerFieldOwnerCropType implements Serializable {
    ...
    public FarmerFieldOwnerCropType id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public FarmerFieldOwnerCropType crop(String crop) {
        this.setCrop(crop);
        return this;
    }
    ...
    public FarmerFieldOwnerCropType image(String image) {
        this.setImage(image);
        return this;
    }
    ...
    public FarmerFieldOwnerCropType mainCrop(Integer mainCrop) {
    ...
    public FarmerFieldOwnerCropType cropCode(String cropCode) {
    ...
    public FarmerFieldOwnerCropType noOfStages(String noOfStages) {
    ...
    public FarmerFieldOwnerCropType description(String description) {
    ...
    public FarmerFieldOwnerCropType cropTypesId(Integer cropTypesId) {
    ...
    public FarmerFieldOwnerCropType unitsId(Integer unitsId) {
    ...
    public FarmerFieldOwnerCropType area(Double area) {
        this.setArea(area);
        return this;
    }
    ...
    public FarmerFieldOwnerCropType sumInsured(Double sumInsured) {
    ...
    public FarmerFieldOwnerCropType minSumInsured(Double minSumInsured) {
    ...
    public FarmerFieldOwnerCropType maxSumInsured(Double maxSumInsured) {
    ...
    public FarmerFieldOwnerCropType subsidisedPremiumRate(Double subsidisedPremiumRate) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof FarmerFieldOwnerCropType)) {
            return false;
        }
        return getId() != null && getId().equals(((FarmerFieldOwnerCropType) o).getId());
    }
    ...
    public String toString() {
        return "FarmerFieldOwnerCropType{" +
            "id=" + getId() +
            ", crop='" + getCrop() + "'" +
            ", image='" + getImage() + "'" +
