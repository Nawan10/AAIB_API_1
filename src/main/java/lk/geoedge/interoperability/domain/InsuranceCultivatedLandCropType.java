...
/**
 * A InsuranceCultivatedLandCropType.
 */
@Entity
@Table(name = "crop_type")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class InsuranceCultivatedLandCropType implements Serializable {
    ...
    public InsuranceCultivatedLandCropType id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public InsuranceCultivatedLandCropType crop(String crop) {
        this.setCrop(crop);
        return this;
    }
    ...
    public InsuranceCultivatedLandCropType image(String image) {
        this.setImage(image);
        return this;
    }
    ...
    public InsuranceCultivatedLandCropType mainCrop(Integer mainCrop) {
    ...
    public InsuranceCultivatedLandCropType cropCode(String cropCode) {
    ...
    public InsuranceCultivatedLandCropType noOfStages(String noOfStages) {
    ...
    public InsuranceCultivatedLandCropType description(String description) {
    ...
    public InsuranceCultivatedLandCropType cropTypesId(Integer cropTypesId) {
    ...
    public InsuranceCultivatedLandCropType unitsId(Integer unitsId) {
    ...
    public InsuranceCultivatedLandCropType area(Double area) {
        this.setArea(area);
        return this;
    }
    ...
    public InsuranceCultivatedLandCropType sumInsured(Double sumInsured) {
    ...
    public InsuranceCultivatedLandCropType minSumInsured(Double minSumInsured) {
    ...
    public InsuranceCultivatedLandCropType maxSumInsured(Double maxSumInsured) {
    ...
    public InsuranceCultivatedLandCropType subsidisedPremiumRate(Double subsidisedPremiumRate) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof InsuranceCultivatedLandCropType)) {
            return false;
        }
        return getId() != null && getId().equals(((InsuranceCultivatedLandCropType) o).getId());
    }
    ...
    public String toString() {
        return "InsuranceCultivatedLandCropType{" +
            "id=" + getId() +
            ", crop='" + getCrop() + "'" +
            ", image='" + getImage() + "'" +
