...
/**
 * A IndexPolicyCropType.
 */
@Entity
@Table(name = "crop_type")
@SuppressWarnings("common-java:DuplicatedBlocks")
public class IndexPolicyCropType implements Serializable {
    ...
    public IndexPolicyCropType id(Long id) {
        this.setId(id);
        return this;
    }
    ...
    public IndexPolicyCropType crop(String crop) {
        this.setCrop(crop);
        return this;
    }
    ...
    public IndexPolicyCropType image(String image) {
        this.setImage(image);
        return this;
    }
    ...
    public IndexPolicyCropType mainCrop(Integer mainCrop) {
    ...
    public IndexPolicyCropType cropCode(String cropCode) {
    ...
    public IndexPolicyCropType noOfStages(String noOfStages) {
    ...
    public IndexPolicyCropType description(String description) {
    ...
    public IndexPolicyCropType cropTypesId(Integer cropTypesId) {
    ...
    public IndexPolicyCropType unitsId(Integer unitsId) {
    ...
    public IndexPolicyCropType area(Double area) {
        this.setArea(area);
        return this;
    }
    ...
    public IndexPolicyCropType sumInsured(Double sumInsured) {
    ...
    public IndexPolicyCropType minSumInsured(Double minSumInsured) {
    ...
    public IndexPolicyCropType maxSumInsured(Double maxSumInsured) {
    ...
    public IndexPolicyCropType subsidisedPremiumRate(Double subsidisedPremiumRate) {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof IndexPolicyCropType)) {
            return false;
        }
        return getId() != null && getId().equals(((IndexPolicyCropType) o).getId());
    }
