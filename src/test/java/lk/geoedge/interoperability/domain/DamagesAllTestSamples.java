...
public class DamagesAllTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static DamagesAll getDamagesAllSample1() {
    ...
    public static DamagesAll getDamagesAllSample2() {
        return new DamagesAll()
            .id(2L)
    ...
    public static DamagesAll getDamagesAllRandomSampleGenerator() {
        return new DamagesAll()
