...
public class CanlendarCropCropTypeAsserts {
     ...
     */
    public static void assertCanlendarCropCropTypeAllPropertiesEquals(CanlendarCropCropType expected, CanlendarCropCropType actual) {
        assertCanlendarCropCropTypeAutoGeneratedPropertiesEquals(expected, actual);
        assertCanlendarCropCropTypeAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertCanlendarCropCropTypeAllUpdatablePropertiesEquals(
        CanlendarCropCropType expected,
        CanlendarCropCropType actual
    ) {
        assertCanlendarCropCropTypeUpdatableFieldsEquals(expected, actual);
        assertCanlendarCropCropTypeUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertCanlendarCropCropTypeAutoGeneratedPropertiesEquals(
        CanlendarCropCropType expected,
        CanlendarCropCropType actual
    ) {
        assertThat(actual)
            .as("Verify CanlendarCropCropType auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertCanlendarCropCropTypeUpdatableFieldsEquals(CanlendarCropCropType expected, CanlendarCropCropType actual) {
        assertThat(actual)
            .as("Verify CanlendarCropCropType relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertCanlendarCropCropTypeUpdatableRelationshipsEquals(
        CanlendarCropCropType expected,
        CanlendarCropCropType actual
    ) {
        // empty method
