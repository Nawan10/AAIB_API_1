...
public class CultivatedLandFarmersFarmerAsserts {
     ...
     */
    public static void assertCultivatedLandFarmersFarmerAllPropertiesEquals(
        CultivatedLandFarmersFarmer expected,
        CultivatedLandFarmersFarmer actual
    ) {
        assertCultivatedLandFarmersFarmerAutoGeneratedPropertiesEquals(expected, actual);
        assertCultivatedLandFarmersFarmerAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertCultivatedLandFarmersFarmerAllUpdatablePropertiesEquals(
        CultivatedLandFarmersFarmer expected,
        CultivatedLandFarmersFarmer actual
    ) {
        assertCultivatedLandFarmersFarmerUpdatableFieldsEquals(expected, actual);
        assertCultivatedLandFarmersFarmerUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertCultivatedLandFarmersFarmerAutoGeneratedPropertiesEquals(
        CultivatedLandFarmersFarmer expected,
        CultivatedLandFarmersFarmer actual
    ) {
        assertThat(actual)
            .as("Verify CultivatedLandFarmersFarmer auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertCultivatedLandFarmersFarmerUpdatableFieldsEquals(
        CultivatedLandFarmersFarmer expected,
        CultivatedLandFarmersFarmer actual
    ) {
        assertThat(actual)
            .as("Verify CultivatedLandFarmersFarmer relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertCultivatedLandFarmersFarmerUpdatableRelationshipsEquals(
        CultivatedLandFarmersFarmer expected,
        CultivatedLandFarmersFarmer actual
    ) {
        // empty method
