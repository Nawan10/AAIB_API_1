...
public class CultivatedLandFarmerTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static CultivatedLandFarmer getCultivatedLandFarmerSample1() {
    ...
    public static CultivatedLandFarmer getCultivatedLandFarmerSample2() {
        return new CultivatedLandFarmer()
            .id(2L)
            .farmerId("farmerId2")
    ...
    public static CultivatedLandFarmer getCultivatedLandFarmerRandomSampleGenerator() {
        return new CultivatedLandFarmer()
