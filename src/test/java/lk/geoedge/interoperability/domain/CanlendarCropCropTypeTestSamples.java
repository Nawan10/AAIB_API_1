...
public class CanlendarCropCropTypeTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static CanlendarCropCropType getCanlendarCropCropTypeSample1() {
    ...
    public static CanlendarCropCropType getCanlendarCropCropTypeSample2() {
        return new CanlendarCropCropType()
            .id(2L)
            .crop("crop2")
            .image("image2")
    ...
    public static CanlendarCropCropType getCanlendarCropCropTypeRandomSampleGenerator() {
        return new CanlendarCropCropType()
