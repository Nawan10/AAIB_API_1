...
public class CultivatedCropCropTypeAsserts {
     ...
     */
    public static void assertCultivatedCropCropTypeAllPropertiesEquals(CultivatedCropCropType expected, CultivatedCropCropType actual) {
        assertCultivatedCropCropTypeAutoGeneratedPropertiesEquals(expected, actual);
        assertCultivatedCropCropTypeAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertCultivatedCropCropTypeAllUpdatablePropertiesEquals(
        CultivatedCropCropType expected,
        CultivatedCropCropType actual
    ) {
        assertCultivatedCropCropTypeUpdatableFieldsEquals(expected, actual);
        assertCultivatedCropCropTypeUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertCultivatedCropCropTypeAutoGeneratedPropertiesEquals(
        CultivatedCropCropType expected,
        CultivatedCropCropType actual
    ) {
        assertThat(actual)
            .as("Verify CultivatedCropCropType auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertCultivatedCropCropTypeUpdatableFieldsEquals(CultivatedCropCropType expected, CultivatedCropCropType actual) {
        assertThat(actual)
            .as("Verify CultivatedCropCropType relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertCultivatedCropCropTypeUpdatableRelationshipsEquals(
        CultivatedCropCropType expected,
        CultivatedCropCropType actual
    ) {
        // empty method
