...
public class CropDurationCropTypeTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static CropDurationCropType getCropDurationCropTypeSample1() {
    ...
    public static CropDurationCropType getCropDurationCropTypeSample2() {
        return new CropDurationCropType()
            .id(2L)
            .crop("crop2")
            .image("image2")
    ...
    public static CropDurationCropType getCropDurationCropTypeRandomSampleGenerator() {
        return new CropDurationCropType()
