...
public class FarmerFieldLandOwnerFarmerTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static FarmerFieldLandOwnerFarmer getFarmerFieldLandOwnerFarmerSample1() {
    ...
    public static FarmerFieldLandOwnerFarmer getFarmerFieldLandOwnerFarmerSample2() {
        return new FarmerFieldLandOwnerFarmer()
            .id(2L)
            .farmerId("farmerId2")
    ...
    public static FarmerFieldLandOwnerFarmer getFarmerFieldLandOwnerFarmerRandomSampleGenerator() {
        return new FarmerFieldLandOwnerFarmer()
