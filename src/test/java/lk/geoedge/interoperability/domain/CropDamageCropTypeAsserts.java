...
public class CropDamageCropTypeAsserts {
     ...
     */
    public static void assertCropDamageCropTypeAllPropertiesEquals(CropDamageCropType expected, CropDamageCropType actual) {
        assertCropDamageCropTypeAutoGeneratedPropertiesEquals(expected, actual);
        assertCropDamageCropTypeAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertCropDamageCropTypeAllUpdatablePropertiesEquals(CropDamageCropType expected, CropDamageCropType actual) {
        assertCropDamageCropTypeUpdatableFieldsEquals(expected, actual);
        assertCropDamageCropTypeUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertCropDamageCropTypeAutoGeneratedPropertiesEquals(CropDamageCropType expected, CropDamageCropType actual) {
        assertThat(actual)
            .as("Verify CropDamageCropType auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertCropDamageCropTypeUpdatableFieldsEquals(CropDamageCropType expected, CropDamageCropType actual) {
        assertThat(actual)
            .as("Verify CropDamageCropType relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertCropDamageCropTypeUpdatableRelationshipsEquals(CropDamageCropType expected, CropDamageCropType actual) {
        // empty method
    }
}
