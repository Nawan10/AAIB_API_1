...
public class CultivatedLandFarmersFarmerTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static CultivatedLandFarmersFarmer getCultivatedLandFarmersFarmerSample1() {
    ...
    public static CultivatedLandFarmersFarmer getCultivatedLandFarmersFarmerSample2() {
        return new CultivatedLandFarmersFarmer()
            .id(2L)
            .farmerId("farmerId2")
    ...
    public static CultivatedLandFarmersFarmer getCultivatedLandFarmersFarmerRandomSampleGenerator() {
        return new CultivatedLandFarmersFarmer()
