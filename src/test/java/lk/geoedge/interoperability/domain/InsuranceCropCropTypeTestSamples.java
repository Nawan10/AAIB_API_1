...
public class InsuranceCropCropTypeTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static InsuranceCropCropType getInsuranceCropCropTypeSample1() {
    ...
    public static InsuranceCropCropType getInsuranceCropCropTypeSample2() {
        return new InsuranceCropCropType()
            .id(2L)
            .crop("crop2")
            .image("image2")
    ...
    public static InsuranceCropCropType getInsuranceCropCropTypeRandomSampleGenerator() {
        return new InsuranceCropCropType()
