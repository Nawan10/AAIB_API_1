...
public class DamageTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));

    public static Damage getDamageSample1() {
        return new Damage()
            .id(1L)
    ...
    public static Damage getDamageSample2() {
        return new Damage()
            .id(2L)
    ...
    public static Damage getDamageRandomSampleGenerator() {
        return new Damage()
