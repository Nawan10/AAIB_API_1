...
public class FarmerFieldOwnerCropTypeAsserts {
     ...
     */
    public static void assertFarmerFieldOwnerCropTypeAllPropertiesEquals(
        FarmerFieldOwnerCropType expected,
        FarmerFieldOwnerCropType actual
    ) {
        assertFarmerFieldOwnerCropTypeAutoGeneratedPropertiesEquals(expected, actual);
        assertFarmerFieldOwnerCropTypeAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertFarmerFieldOwnerCropTypeAllUpdatablePropertiesEquals(
        FarmerFieldOwnerCropType expected,
        FarmerFieldOwnerCropType actual
    ) {
        assertFarmerFieldOwnerCropTypeUpdatableFieldsEquals(expected, actual);
        assertFarmerFieldOwnerCropTypeUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertFarmerFieldOwnerCropTypeAutoGeneratedPropertiesEquals(
        FarmerFieldOwnerCropType expected,
        FarmerFieldOwnerCropType actual
    ) {
        assertThat(actual)
            .as("Verify FarmerFieldOwnerCropType auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertFarmerFieldOwnerCropTypeUpdatableFieldsEquals(
        FarmerFieldOwnerCropType expected,
        FarmerFieldOwnerCropType actual
    ) {
        assertThat(actual)
            .as("Verify FarmerFieldOwnerCropType relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertFarmerFieldOwnerCropTypeUpdatableRelationshipsEquals(
        FarmerFieldOwnerCropType expected,
        FarmerFieldOwnerCropType actual
    ) {
        // empty method
