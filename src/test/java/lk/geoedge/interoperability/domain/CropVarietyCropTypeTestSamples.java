...
public class CropVarietyCropTypeTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static CropVarietyCropType getCropVarietyCropTypeSample1() {
    ...
    public static CropVarietyCropType getCropVarietyCropTypeSample2() {
        return new CropVarietyCropType()
            .id(2L)
            .crop("crop2")
            .image("image2")
    ...
    public static CropVarietyCropType getCropVarietyCropTypeRandomSampleGenerator() {
        return new CropVarietyCropType()
