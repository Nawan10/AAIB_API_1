...
public class CultivatedCropCropTypeTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static CultivatedCropCropType getCultivatedCropCropTypeSample1() {
    ...
    public static CultivatedCropCropType getCultivatedCropCropTypeSample2() {
        return new CultivatedCropCropType()
            .id(2L)
            .crop("crop2")
            .image("image2")
    ...
    public static CultivatedCropCropType getCultivatedCropCropTypeRandomSampleGenerator() {
        return new CultivatedCropCropType()
