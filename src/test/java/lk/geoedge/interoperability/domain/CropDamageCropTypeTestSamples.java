...
public class CropDamageCropTypeTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static CropDamageCropType getCropDamageCropTypeSample1() {
    ...
    public static CropDamageCropType getCropDamageCropTypeSample2() {
        return new CropDamageCropType()
            .id(2L)
            .crop("crop2")
            .image("image2")
    ...
    public static CropDamageCropType getCropDamageCropTypeRandomSampleGenerator() {
        return new CropDamageCropType()
