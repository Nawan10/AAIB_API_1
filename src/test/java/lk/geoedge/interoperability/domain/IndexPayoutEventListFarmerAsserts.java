...
public class IndexPayoutEventListFarmerAsserts {
     ...
     */
    public static void assertIndexPayoutEventListFarmerAllPropertiesEquals(
        IndexPayoutEventListFarmer expected,
        IndexPayoutEventListFarmer actual
    ) {
        assertIndexPayoutEventListFarmerAutoGeneratedPropertiesEquals(expected, actual);
        assertIndexPayoutEventListFarmerAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertIndexPayoutEventListFarmerAllUpdatablePropertiesEquals(
        IndexPayoutEventListFarmer expected,
        IndexPayoutEventListFarmer actual
    ) {
        assertIndexPayoutEventListFarmerUpdatableFieldsEquals(expected, actual);
        assertIndexPayoutEventListFarmerUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertIndexPayoutEventListFarmerAutoGeneratedPropertiesEquals(
        IndexPayoutEventListFarmer expected,
        IndexPayoutEventListFarmer actual
    ) {
        assertThat(actual)
            .as("Verify IndexPayoutEventListFarmer auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertIndexPayoutEventListFarmerUpdatableFieldsEquals(
        IndexPayoutEventListFarmer expected,
        IndexPayoutEventListFarmer actual
    ) {
        assertThat(actual)
            .as("Verify IndexPayoutEventListFarmer relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertIndexPayoutEventListFarmerUpdatableRelationshipsEquals(
        IndexPayoutEventListFarmer expected,
        IndexPayoutEventListFarmer actual
    ) {
        // empty method
