...
public class InsuranceCultivatedLandCropTypeAsserts {
     ...
     */
    public static void assertInsuranceCultivatedLandCropTypeAllPropertiesEquals(
        InsuranceCultivatedLandCropType expected,
        InsuranceCultivatedLandCropType actual
    ) {
        assertInsuranceCultivatedLandCropTypeAutoGeneratedPropertiesEquals(expected, actual);
        assertInsuranceCultivatedLandCropTypeAllUpdatablePropertiesEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertInsuranceCultivatedLandCropTypeAllUpdatablePropertiesEquals(
        InsuranceCultivatedLandCropType expected,
        InsuranceCultivatedLandCropType actual
    ) {
        assertInsuranceCultivatedLandCropTypeUpdatableFieldsEquals(expected, actual);
        assertInsuranceCultivatedLandCropTypeUpdatableRelationshipsEquals(expected, actual);
    }
     ...
     * @param actual the actual entity
     */
    public static void assertInsuranceCultivatedLandCropTypeAutoGeneratedPropertiesEquals(
        InsuranceCultivatedLandCropType expected,
        InsuranceCultivatedLandCropType actual
    ) {
        assertThat(actual)
            .as("Verify InsuranceCultivatedLandCropType auto generated properties")
     ...
     * @param actual the actual entity
     */
    public static void assertInsuranceCultivatedLandCropTypeUpdatableFieldsEquals(
        InsuranceCultivatedLandCropType expected,
        InsuranceCultivatedLandCropType actual
    ) {
        assertThat(actual)
            .as("Verify InsuranceCultivatedLandCropType relevant properties")
     ...
     * @param actual the actual entity
     */
    public static void assertInsuranceCultivatedLandCropTypeUpdatableRelationshipsEquals(
        InsuranceCultivatedLandCropType expected,
        InsuranceCultivatedLandCropType actual
    ) {
        // empty method
