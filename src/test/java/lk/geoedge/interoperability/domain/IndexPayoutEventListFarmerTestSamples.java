...
public class IndexPayoutEventListFarmerTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static IndexPayoutEventListFarmer getIndexPayoutEventListFarmerSample1() {
    ...
    public static IndexPayoutEventListFarmer getIndexPayoutEventListFarmerSample2() {
        return new IndexPayoutEventListFarmer()
            .id(2L)
            .farmerId("farmerId2")
    ...
    public static IndexPayoutEventListFarmer getIndexPayoutEventListFarmerRandomSampleGenerator() {
        return new IndexPayoutEventListFarmer()
